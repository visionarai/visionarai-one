...
export const ToggleButton = ({ placement, onClick, className }: ToggleButtonProps) => {
	return (
		<Button
			...
			className={`fixed h-6 w-32 bg-gradient-to-r from-slate-700 via-slate-800 to-slate-900 font-medium text-white text-xs shadow-lg ring-1 ring-white/10 ring-inset transition-all ${className || ""}`}
			onClick={onClick}
