import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle } from "@visionarai-one/ui";
...
function CommandList({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.List>) {
	return <CommandPrimitive.List className={cn("max-h-[300px] scroll-py-1 overflow-y-auto overflow-x-hidden", className)} data-slot="command-list" {...props} />;
}
